...
# ----------------------------
model_file = 'VGG_ILSVRC_16_layers.mlmodel'
...
path_lib = "vgg16_deploy_lib.so"
lib.export_library(path_lib)
with open("vgg16_deploy_graph.json", "w") as fo:
    fo.write(graph)
with open("vgg16_deploy_param.params", "wb") as fo:
