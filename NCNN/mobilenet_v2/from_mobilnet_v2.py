...
# ----------------------------
model_file = 'mobilenet_v2.mlmodel'
...
path_lib = "mobilenet_v2_deploy_lib.so"
lib.export_library(path_lib)
with open("mobilenet_v2_deploy_graph.json", "w") as fo:
    fo.write(graph)
with open("mobile_v2_deploy_param.params", "wb") as fo:
